...
const CONFIG = {
  ...
  accounts: {
    groom: [
      ...
      { role: "아버지", name: "천무웅", bank: "신한은행", number: "123-456-123456" },
      { role: "어머니", name: "권선옥", bank: "우리은행", number: "123-456-123456" }
    ],
    bride: [
      { role: "신부", name: "이혜인", bank: "IM뱅크", number: "059-13-129244" },
      { role: "아버지", name: "이헌동", bank: "농협은행", number: "737039-52-000998" },
      { role: "어머니", name: "윤여애", bank: "농협은행", number: "737039-56-013308" }
    ]
  },
  ...
  meta: {
    title: "성준 ♥ 혜인 결혼합니다",
    description: "2026년 10월 4일, 소중한 분들을 초대합니다."
  }
};
